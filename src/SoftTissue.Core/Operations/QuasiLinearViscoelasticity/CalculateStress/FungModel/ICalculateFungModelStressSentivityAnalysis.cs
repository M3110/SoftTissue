...
namespace SoftTissue.Core.Operations.QuasiLinearViscoelasticity.CalculateStress.FungModel
{
    ...
    /// </summary>
    public interface ICalculateFungModelStressSentivityAnalysis : ICalculateQuasiLinearViscoelasticityStress<CalculateFungModelStressSensitivityAnalysisRequest> { }
}