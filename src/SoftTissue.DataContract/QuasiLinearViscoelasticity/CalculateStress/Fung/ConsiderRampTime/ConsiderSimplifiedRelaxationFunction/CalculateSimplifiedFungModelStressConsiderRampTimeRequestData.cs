...
namespace SoftTissue.DataContract.QuasiLinearViscoelasticity.CalculateStress.Fung.ConsiderRampTime.ConsiderSimplifiedRelaxationFunction
{
    ...
    /// </summary>
    public class CalculateSimplifiedFungModelStressConsiderRampTimeRequestData : CalculateStressConsiderRampTimeRequestData<SimplifiedReducedRelaxationFunctionData> 
    {
    }
}
